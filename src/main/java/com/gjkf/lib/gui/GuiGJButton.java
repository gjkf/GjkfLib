...
public class GuiGJButton extends GuiWidget{
    public String text;
    public String actionCommand;
    private boolean isEnabled = true;
    public boolean drawButton = true;
    
    public GuiGJButton(int x, int y, int width, int height, String text){
    ...
    public GuiGJButton setActionCommand(String string){
