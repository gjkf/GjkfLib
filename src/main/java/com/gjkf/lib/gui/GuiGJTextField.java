...
public class GuiGJTextField extends GuiWidget{
    ...
    public GuiGJTextField(int x, int y, int width, int height, String text){
    ...
    public GuiGJTextField setMaxStringLength(int i){
        maxStringLength = i;
        return this;
    }
