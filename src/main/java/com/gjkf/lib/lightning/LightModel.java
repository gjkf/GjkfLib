...
public class LightModel implements GJRenderState.IVertexOperation
{
    ...
    public boolean load() {
        ...
        GJRenderState.pipeline.addDependency(GJRenderState.normalAttrib);
    ...
    @Override
    public void operate() {
    	GJRenderState.setColour(apply(GJRenderState.colour, GJRenderState.normal));
    }
