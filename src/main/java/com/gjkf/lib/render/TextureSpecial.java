...
import com.gjkf.lib.render.SpriteSheetManager.SpriteSheet;
import com.gjkf.lib.util.TextureUtils;
import com.gjkf.lib.util.TextureUtils.IIconSelfRegister;
...
public class TextureSpecial extends TextureAtlasSprite implements IIconSelfRegister {
    ...
    public TextureSpecial(String par1) {
        super(par1);
    }
